...
DEFAULT_PACKAGES:=base-files libc libgcc busybox dropbear mtd uci opkg netifd fstools uclient-fetch logd urandom-seed urngd wget luci luci-compat luci-lib-ipkg \
default-settings
# For nas targets
